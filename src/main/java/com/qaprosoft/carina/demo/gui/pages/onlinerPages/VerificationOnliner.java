...
public class VerificationOnliner extends AbstractPage {

    private static final Logger LOGGER = LoggerFactory.getLogger(VerificationOnliner.class);

    public VerificationOnliner(WebDriver driver) {
        super(driver);
